...
namespace HomeApi.Data.Repos
{
    ...
    public class DeviceRepository : IDeviceRepository
    {
        ...
        /// <summary>
        /// Обновить название комнаты у устройств
        /// </summary>
        public async Task UpdateDeviceRoom(Room room)
        {
            var devices = _context.Devices.Include(d => d.Room).Where(o => o.RoomId == room.Id).ToArray();
